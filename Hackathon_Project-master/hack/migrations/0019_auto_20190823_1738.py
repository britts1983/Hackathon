# Generated by Django 2.2.2 on 2019-08-23 12:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hack', '0018_auto_20190823_1050'),
    ]

    operations = [
        migrations.CreateModel(
            name='Hackathon_Applicants',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FIRST_NAME', models.CharField(blank=True, max_length=60, null=True)),
                ('MIDDLE_NAME', models.CharField(blank=True, max_length=61, null=True)),
                ...
                ('STATUS', models.CharField(blank=True, choices=[('Pending', 'PENDING'), ('Checking', 'CHECKING'), ('Approved', 'APPROVED'), ('Rejected', 'REJECTED')], default='Pending', max_length=10, null=True)),
